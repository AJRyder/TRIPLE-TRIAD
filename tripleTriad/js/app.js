...
const gargant = new TriadCard('Gargantua', 5, 6, 8, 6, "../img/cards/070.png")
...
const game = {
    ...
    randomizeDeck(array){
        ...
        cardRender() {
            $('#playerCardOne').append(players.humanCards[0].image)
            $('#playerCardTwo').append(players.humanCards[1].image)
            $('#playerCardThree').append(players.humanCards[2].image)
            $('#playerCardFour').append(players.humanCards[3].image)
            $('#playerCardFive').append(players.humanCards[4].image)

            // $('#compCardOne').append(players.compCards[0].image)
            $('#compCardOne').data(players.compCards[0].topVal, )
            $('#compCardTwo').append(players.compCards[1].image)
            $('#compCardThree').append(players.compCards[2].image)
            $('#compCardFour').append(players.compCards[3].image)
            $('#compCardFive').append(players.compCards[4].image)
        }
